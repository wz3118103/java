package basics.annotation.corejava.v2ch08.runtimeAnnotations;

import corejava.v2ch08.runtimeAnnotations.ActionListenerFor;
...
public class ActionListenerInstaller
{
   ...
   public static void processAnnotations(Object obj)
   {
      try
      {
         ...
         {
            corejava.v2ch08.runtimeAnnotations.ActionListenerFor a = m.getAnnotation(ActionListenerFor.class);
            if (a != null)
            {
