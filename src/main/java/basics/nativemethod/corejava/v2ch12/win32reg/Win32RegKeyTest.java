package basics.nativemethod.corejava.v2ch12.win32reg;

import corejava.v2ch12.win32reg.Win32RegKey;
...
{  
   ...
   {  
      corejava.v2ch12.win32reg.Win32RegKey key = new corejava.v2ch12.win32reg.Win32RegKey(
