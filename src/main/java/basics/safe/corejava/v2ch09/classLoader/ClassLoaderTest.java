package basics.safe.corejava.v2ch09.classLoader;

import corejava.v2ch09.classLoader.GBC;
...
class ClassLoaderFrame extends JFrame
{
   ...
   public ClassLoaderFrame()
   {
      ...
      add(new JLabel("Class"), new corejava.v2ch09.classLoader.GBC(0, 0).setAnchor(corejava.v2ch09.classLoader.GBC.EAST));
      add(nameField, new corejava.v2ch09.classLoader.GBC(1, 0).setWeight(100, 0).setAnchor(corejava.v2ch09.classLoader.GBC.WEST));
      add(new JLabel("Key"), new corejava.v2ch09.classLoader.GBC(0, 1).setAnchor(corejava.v2ch09.classLoader.GBC.EAST));
      add(keyField, new corejava.v2ch09.classLoader.GBC(1, 1).setWeight(100, 0).setAnchor(corejava.v2ch09.classLoader.GBC.WEST));
