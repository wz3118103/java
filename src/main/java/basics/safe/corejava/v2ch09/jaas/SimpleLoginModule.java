package basics.safe.corejava.v2ch09.jaas;

import corejava.v2ch09.jaas.SimplePrincipal;
      ...
      try (Scanner in = new Scanner(Paths.get("" + options.get("pwfile")), "UTF-8"))
      {
         while (in.hasNextLine())
         {
            ...
            if (inputs[0].equals(username) && Arrays.equals(inputs[1].toCharArray(), password))
            {
               ...
               principals.add(new corejava.v2ch09.jaas.SimplePrincipal("username", username));
