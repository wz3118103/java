package library.locale.corejava.v2ch07.collation;

import corejava.v2ch07.collation.EnumCombo;
import corejava.v2ch07.collation.GBC;
...
class CollationFrame extends JFrame
{
   ...
   private corejava.v2ch07.collation.EnumCombo<Integer> strengthCombo = new corejava.v2ch07.collation.EnumCombo<>(Collator.class, "Primary",
         "Secondary", "Tertiary", "Identical");
   private corejava.v2ch07.collation.EnumCombo<Integer> decompositionCombo = new EnumCombo<>(Collator.class,
         "Canonical Decomposition", "Full Decomposition", "No Decomposition");

   public CollationFrame()
   {
      setLayout(new GridBagLayout());
      add(new JLabel("Locale"), new corejava.v2ch07.collation.GBC(0, 0).setAnchor(corejava.v2ch07.collation.GBC.EAST));
      add(new JLabel("Strength"), new corejava.v2ch07.collation.GBC(0, 1).setAnchor(corejava.v2ch07.collation.GBC.EAST));
      add(new JLabel("Decomposition"), new corejava.v2ch07.collation.GBC(0, 2).setAnchor(corejava.v2ch07.collation.GBC.EAST));
      add(addButton, new corejava.v2ch07.collation.GBC(0, 3).setAnchor(corejava.v2ch07.collation.GBC.EAST));
      add(localeCombo, new corejava.v2ch07.collation.GBC(1, 0).setAnchor(corejava.v2ch07.collation.GBC.WEST));
      add(strengthCombo, new corejava.v2ch07.collation.GBC(1, 1).setAnchor(corejava.v2ch07.collation.GBC.WEST));
      add(decompositionCombo, new corejava.v2ch07.collation.GBC(1, 2).setAnchor(corejava.v2ch07.collation.GBC.WEST));
      add(newWord, new corejava.v2ch07.collation.GBC(1, 3).setFill(corejava.v2ch07.collation.GBC.HORIZONTAL));
      add(new JScrollPane(sortedWords), new corejava.v2ch07.collation.GBC(0, 4, 2, 1).setFill(GBC.BOTH));
