package library.locale.corejava.v2ch07.numberFormat;

import corejava.v2ch07.numberFormat.GBC;
...
class NumberFormatFrame extends JFrame
{
   ...
   {      
      ...
      add(new JLabel("Locale:"), new corejava.v2ch07.numberFormat.GBC(0, 0).setAnchor(corejava.v2ch07.numberFormat.GBC.EAST));
      add(p, new corejava.v2ch07.numberFormat.GBC(1, 1));
      add(parseButton, new corejava.v2ch07.numberFormat.GBC(0, 2).setInsets(2));
      add(localeCombo, new corejava.v2ch07.numberFormat.GBC(1, 0).setAnchor(corejava.v2ch07.numberFormat.GBC.WEST));
      add(numberText, new corejava.v2ch07.numberFormat.GBC(1, 2).setFill(GBC.HORIZONTAL));
