package library.locale.corejava.v2ch07.retire;

import corejava.v2ch07.retire.GBC;
import corejava.v2ch07.retire.LocaleCombo;
...
class RetireFrame extends JFrame
{
   ...
   public RetireFrame()
   {
      ...
      add(languageLabel, new corejava.v2ch07.retire.GBC(0, 0).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(savingsLabel, new corejava.v2ch07.retire.GBC(0, 1).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(contribLabel, new corejava.v2ch07.retire.GBC(2, 1).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(incomeLabel, new corejava.v2ch07.retire.GBC(4, 1).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(currentAgeLabel, new corejava.v2ch07.retire.GBC(0, 2).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(retireAgeLabel, new corejava.v2ch07.retire.GBC(2, 2).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(deathAgeLabel, new corejava.v2ch07.retire.GBC(4, 2).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(inflationPercentLabel, new corejava.v2ch07.retire.GBC(0, 3).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(investPercentLabel, new corejava.v2ch07.retire.GBC(2, 3).setAnchor(corejava.v2ch07.retire.GBC.EAST));
      add(localeCombo, new corejava.v2ch07.retire.GBC(1, 0, 3, 1));
      add(savingsField, new corejava.v2ch07.retire.GBC(1, 1).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(contribField, new corejava.v2ch07.retire.GBC(3, 1).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(incomeField, new corejava.v2ch07.retire.GBC(5, 1).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(currentAgeField, new corejava.v2ch07.retire.GBC(1, 2).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(retireAgeField, new corejava.v2ch07.retire.GBC(3, 2).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(deathAgeField, new corejava.v2ch07.retire.GBC(5, 2).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(inflationPercentField, new corejava.v2ch07.retire.GBC(1, 3).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(investPercentField, new corejava.v2ch07.retire.GBC(3, 3).setWeight(100, 0).setFill(corejava.v2ch07.retire.GBC.HORIZONTAL));
      add(retireCanvas, new corejava.v2ch07.retire.GBC(0, 4, 4, 1).setWeight(100, 100).setFill(corejava.v2ch07.retire.GBC.BOTH));
      add(new JScrollPane(retireText), new corejava.v2ch07.retire.GBC(4, 4, 2, 1).setWeight(0, 100).setFill(corejava.v2ch07.retire.GBC.BOTH));
