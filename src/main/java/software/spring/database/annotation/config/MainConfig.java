package software.spring.database.annotation.config;
...
@Configuration
@ComponentScan("software.spring.database.annotation")
...
public class MainConfig {
	...
	public DataSource dataSource() throws PropertyVetoException{
		...
		dataSource.setPassword("Wz3118103y!");
		dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
		dataSource.setUrl("jdbc:mysql://119.3.135.196:3306/mybatis?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true");
		return dataSource;
	}
