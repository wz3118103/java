...
import software.mybatis.demo.mapper.TJobHistoryAnnoMapper;
import software.mybatis.demo.mapper.TUserMapper;
...
public class MybatisDemo {
	...
	public void init() throws IOException {
		...
		String resource = "software/mybatis/demo/mybatis-demo-config.xml";
...
//		user2.setId(131);
	...
	public void testSelectIfOper() {
		...
		list = mapper.selectIfandWhereOper(email, sex);
		System.out.println(list.size());
	}
...
//		SqlSession sqlSession = sqlSessionFactory.openSession(ExecutorType.BATCH, false);
		...
		TUser user1 = new TUser();
//		user1.setId(3);
		user1.setUserName("cindyHi");
		user1.setRealName("王二麻子");
